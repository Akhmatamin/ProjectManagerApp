...
from app.auth.repository import AuthRepository, RedisRepository, redis_client
...
class Container(containers.DeclarativeContainer):
    ...
    redis_repository_auth = providers.Factory(RedisRepository,redis_client=providers.Object(redis_client))
