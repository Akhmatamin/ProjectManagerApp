...
#     )
#
#     resend_client = providers.Singleton(ResendAPIClient, settings=config)
#
#
...
#
#     s3_service = providers.Singleton(S3Service, settings=config)
#     email_service = providers.Singleton(EmailService, settings=config, resend_client=resend_client)
...
#                                          project_repo=project_repository, s3_service=s3_service)
