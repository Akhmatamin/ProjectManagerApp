...
class ProjectService(IProjectService):
    def __init__(
        ...
        invite_repo: IProjectInviteRepository,
    ...
    async def invite_member(
        ...
        existing_permission = await self.project_repo.get_user_permission(
            project_id, user.id
        )
        ...
        project_member = ProjectMember(
            project_id=project_id, user_id=user.id, permission=permission
        )
    ...
    async def share_project_link(
        ...
        await self.invite_repo.save_invite_jti(
            jti=token_jti,
            payload={
        ...
        try:
            ...
            return {"message": f"Email for invite sent to user: {email}"}
